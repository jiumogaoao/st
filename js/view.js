;(function(obj){
	...
	var head=function(){
			...
			this.render=function(){
				if(this.type==1){
					...
					$(this.el).html('<img class="shopName" src="css/images/logo.png"/>'+
	...
	var foot=function(){
		...
		this.render=function(){
			if(this.type==1){
				$(this.el).html('<img class="phoneIcon" src="css/images/phone.png"/>'+
			...
			if(this.type==1){
				var newBanner=$('<div class="banner">'+
						    		'<ul class="bannerCenter">'+
						    			'<img class="bannerPoint" src="css/images/banner00.png"/>'+
						    			'<img class="bannerPoint" src="css/images/banner01.png"/>'+
						    			'<img class="bannerPoint" src="css/images/banner00.png"/>'+
						    			'<div class="clear"></div>'+
						    		'</ul>'+
				...
				var newBanner=$('<div class="goodDetailBanner">'+
					                '<ul class="goodDetailBannerCenter">'+
					                    '<img class="goodDetailBannerPoint" src="css/images/banner00.png"/>'+
					                    '<img class="goodDetailBannerPoint" src="css/images/banner01.png"/>'+
					                    '<img class="goodDetailBannerPoint" src="css/images/banner00.png"/>'+
					                    '<img class="goodDetailBannerPoint" src="css/images/banner01.png"/>'+
					                    '<div class="clear"></div>'+
					                '</ul>'+
	...
	var shoppingList=function(){
		...
		this.render=function(){
			...
			if(this.type==0){
				...
				remove='<img class="shoppingPointRemove" src="css/images/false.png"/>';
	...
	var returnObj = {
		...
		"login":Backbone.View.extend({
            ...
            '<div class="zheng">'+
                '<img src="images/zheng_01.png">'+
                '<img src="images/zheng_02.png">'+
                '<img src="images/zheng_03.png">'+
            '</div>').appendTo($(this.el))
			}
		}),
		/*个人中心*/
		...
		"shop":Backbone.View.extend({
    		...
    		'<div>'+
            	'<a><img src="css/images/shetop_00.png"></a>'+
            '</div>'+
            '<div>'+
            	'<a><img src="css/images/shetop_01.png"></a>'+
            '</div>'+
            '<div>'+
            	'<a><img src="css/images/shetop_02.png"></a>'+
            '</div>'+
            '<div>'+
            	'<a><img src="css/images/shetop_03.png"></a>'+
            '</div>').appendTo($(this.el))
			}
		}),
		/*商品列表*/
